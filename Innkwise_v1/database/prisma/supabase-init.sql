...
CREATE INDEX IF NOT EXISTS "LibraryItem_userId_createdAt_idx" ON "LibraryItem"("userId", "createdAt");
CREATE INDEX IF NOT EXISTS "LibraryItem_userId_kind_idx" ON "LibraryItem"("userId", "kind");
